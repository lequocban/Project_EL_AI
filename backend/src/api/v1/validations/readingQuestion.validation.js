...
/**
 * Schema validate body cho POST /api/v1/reading-lessons/:lessonId/questions
 * Tạo mới một câu hỏi.
 */
...
/**
 * Schema validate body cho POST /api/v1/reading-lessons/:lessonId/questions/bulk
...
/**
 * Schema validate body cho PATCH /api/v1/reading-questions/:id
 * Cập nhật câu hỏi.
 */
...
/**
 * Schema validate body cho DELETE /api/v1/reading-questions/bulk
 * Xóa nhiều câu hỏi.
 */
