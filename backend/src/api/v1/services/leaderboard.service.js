 ...
 * @param {"vocabulary" | "reading" | "listening"} options.skill - Loại kỹ năng
 ...
 */
const getLeaderboardBySkill = async ({
  skill,
  page = 1,
  limit = 10,
  currentUserId = null,
  ...
  const allStats = await leaderboardRepository.getStatsBySkill(skill);
